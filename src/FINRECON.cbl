...
77 WS-ACCOUNTS-PATH           PIC X(80) VALUE "data/ACCOUNTS.DAT".
77 WS-TRANS-PATH              PIC X(80) VALUE "data/TRANS.DAT".
77 WS-RESULTS-PATH            PIC X(80) VALUE "output/RESULTS.DAT".
77 WS-ERRORS-PATH             PIC X(80) VALUE "output/ERRORS.DAT".
77 WS-REPORT-PATH             PIC X(80) VALUE "output/REPORT.TXT".
